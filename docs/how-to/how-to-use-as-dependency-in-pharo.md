# How to use Chalten as dependency in a Pharo product

In order to include **Chalten** as part of your project, you should reference
the package in your product baseline:

1. Define the Chalten repository and version to be used, and the [baseline groups](../reference/Baseline-groups.md)
...
2. Create a method like this one in the baseline class of your product:
    ...
    setUpDependencies: spec
      ...
      spec
        baseline: 'Chalten'
        with: [ spec repository: 'github://github://ba-st/Chalten:v{XX}' ];
        project: 'Chalten-Deployment'
        copyFrom: 'Chalten' with: [ spec loads: 'Deployment' ]
    ```

    This will create `Chalten-Deployment` as a valid target that can be used
...
3. Use the new loading target as a requirement on your packages. For example:
    ...
    spec
      ...
      do: [
        ...
        spec
          package: 'My-Package'
          with: [ spec requires: #('Chalten-Deployment') ] ]
    ```
